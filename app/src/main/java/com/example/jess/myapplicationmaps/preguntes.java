...
import static com.example.jess.myapplicationmaps.inici.nomAlumne;
        ...
        switch(tag){
            case "cccb":
                ...
                imgTick.setOnClickListener(new View.OnClickListener() {
                    ...
                    if(sortir) {
                        ...
                        Fragment2.googleMap.addMarker(new MarkerOptions().position(cccb).title("CCCB").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
            ...
            case "macba":
                ...
                imgTick.setOnClickListener(new View.OnClickListener() {
                    ...
                    if(sortir) {
                        ...
                        Fragment2.googleMap.addMarker(new MarkerOptions().position(macba).title("MACBA").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
                ...
                imgTick.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (sortir) {
                            ...
                            Fragment2.googleMap.addMarker(new MarkerOptions().position(llatzer).title("Esglèsia").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
                ...
                imgTick.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(sortir){
                            ...
                            Fragment2.googleMap.addMarker(new MarkerOptions().position(creu).title("Hospital").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
                ...
                imgTick.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (sortir) {
                            ...
                            Fragment2.googleMap.addMarker(new MarkerOptions().position(municipal).title("Ajuntament").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
                        ...
                        Fragment2.googleMap.addMarker(new MarkerOptions().position(teatre).title("Teatre").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
            ...
            case "modernista":
                ...
                if(sortir){
                    ...
                    Fragment2.googleMap.addMarker(new MarkerOptions().position(modernista).title("Modernisme").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
                    onBackPressed();
                    sortir = false;
                }else {
                    if (i == 14) {
